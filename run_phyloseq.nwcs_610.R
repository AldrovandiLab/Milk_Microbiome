...
write.table(print(CreateTableOne(vars=demo_vars, strata=c("Regimen"), data=demo, smd=T)), file=sprintf("%s/Table_1.%s.by_Subject.txt", output_dir, aim), quote=F, sep="\t", row.names=T, col.names=T)
